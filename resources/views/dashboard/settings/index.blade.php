                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" style="text-align: center" class="form-control"
                                placeholder="{{ __('site.app_name') }}" value="{{ $setting->app_name }}" name="app_name">
                        </div>

                        <div class="form-group">
                            <label for="company_name">{{ __('site.company_name') }}</label>
                            <input type="text" style="text-align: center" name="company_name" class="form-control"
                                placeholder="{{ __('site.company_name') }}" value="{{ $setting->company_name }}">
                        </div>

                        <div class="form-group">
                            <label for="email">{{ __('site.email') }}</label>
                            <input type="email" style="text-align: center" class="form-control"
                                placeholder="{{ __('site.email') }}" value="{{ $setting->email }}" name="email">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" name="phone" id="phone"
                                value="{{ $setting->phone }}"
                                placeholder="{{ __('site.enter') . '  ' . __('site.phone') }}">
                        </div>

                        <div class="form-group">
                            <label for="address">{{ __('site.address') }}</label>
                            <textarea class="form-control" name="address" id="address"
                                placeholder="{{ __('site.enter') . '  ' . __('site.address') }}">{{ $setting->address }}</textarea>
                        </div>
