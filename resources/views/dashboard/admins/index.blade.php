        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card-header-style">
                    ...
                    <a href="{{ route('dashboard.admins.create') }}"><button style="float:right" class="btn btn-primary"
                            title="{{ __('site.create_admins') }}"><i class="fa fa-plus"></i></button></a>
                ...
                <div class="card-body">
                    <form id="searchForm" action="{{ route('dashboard.admins.index') }}" method="GET">
                        @csrf
                        <button style="margin-bottom: 10px" type="button" class="btn btn-warning"
                            id="showFilters">Filters</button>
                        <div class="row" id="filters" style="display: none">
                            <div class="form-group col-md-4" style="border:1px solid #ddd">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" id="from" name="from_to[]"
                                        value="{{ isset(request('from_to')[0]) ? request('from_to')[0] : '' }}"
                                        class="form-control">
                                    <label for="to">{{ __('site.to') }}:</label>
                                    <input type="datetime-local" id="to" name="from_to[]"
                                        value="{{ isset(request('from_to')[1]) ? request('from_to')[1] : '' }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (auth()->user()->hasPermission('update_admins'))
                                                <a href="{{ route('dashboard.admins.edit', $admin->id) }}"><button
                                                        class="btn btn-info"><i class="fa fa-edit"></i></button></a>
                                            @else
                                                <a href="#"><button class="btn btn-info disabled"><i
