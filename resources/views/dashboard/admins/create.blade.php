        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card-header-style">
                    ...
                    <a href="{{ route('dashboard.admins.index') }}"><button style="float:right" class="btn btn-primary"
                            title="{{ __('site.show_admins') }}"><i class="fa fa-eye"></i></button></a>
                    ...
                    <form action="{{ route('dashboard.admins.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                value="{{ old('name') }}" placeholder="{{ __('site.enter') . '  ' . __('site.name') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="username" class="form-control" name="username" id="username"
                                value="{{ old('username') }}"
                                placeholder="{{ __('site.enter') . '  ' . __('site.username') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                value="{{ old('email') }}"
                                placeholder="{{ __('site.enter') . '  ' . __('site.email') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" id="password"
                                value="{{ old('password') }}"
                                placeholder="{{ __('site.enter') . '  ' . __('site.password') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password_confirmation"
                                ...
                                placeholder="{{ __('site.enter') . '  ' . __('site.password_confirmation') }}">
                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header d-flex p-0">
                                            <h3 class="card-title p-3" style="color:#042e7b;font-weight:bold">
                                                ...
                                                @foreach ($perms as $index => $maps)
                                                    <div class="tab-pane" id="{{ $index }}">
                                                        @foreach ($perms[$index] as $map)
                                                            <label><input type="checkbox" checked name="permissions[]"
                                                                    value="{{ $map }}_{{ $index }}">
                                                                {{ __('site.' . $map) }} </label> <br>
                                                        @endforeach
                                                    </div>
                                                @endforeach
                                                <!-- /.tab-pane -->
