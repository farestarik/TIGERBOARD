        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header card-header-style">
                <h3 class="card-title" style="float: left">{{__("site.create_vendors")}}</h3>
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{route("dashboard.vendors.store")}}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="field" id="field" value="{{old("field")}}" placeholder="{{__('site.enter') . '  ' . __('site.field')}}">
                </div>


                <div class="form-group">
                    <label for="phone">{{__('site.phone')}}</label>
                    <input type="text" class="form-control" name="phone" id="phone" value="{{old("phone")}}" placeholder="{{__('site.enter') . '  ' . __('site.phone')}}">
                </div>
